...
void start()
{
    ...
    AT91C_BASE_PMC -> PMC_PCER = (1 << AT91C_ID_PIOCDE); // peripheral clock enable
    AT91C_BASE_PIOB -> PIO_CODR = PB(29);
    *AT91C_PIOC_PER=AT91C_PIO_PC5;

    long int PIV = AT91B_MCK/150000;
    AT91C_BASE_PITC->PITC_PIMR = AT91C_PITC_PITEN | PIV; // = 1<<24 | PIV; // uruchomienie timera
}
...
int PITdelay()
{
    ...
    AT91C_BASE_PITC -> PITC_PIVR; // kasowanie odczytu
    return 0;
}
